...
module.exports.sockets = {
  ...
  ***************************************************************************/
   beforeConnect: function(handshake, cb) {
	 ...
	 //console.log(handshake.socket.parser.incoming.client._idleNext);
	 /*
		var log_msg = '[xxxxxx]: ' + sails.util.inspect(handshake.socket.parser.incoming.client,{depth:5}) + "\n";
		sails.util.fs.appendFile('logs/socket.log',log_msg,function(err){
  ...
  ***************************************************************************/
   afterDisconnect: function(session, socket, cb) {
	 ...
	 //console.log(typeof session.destroy);
	 //console.log(sails.util.inspect(socket));
     return cb();
   },
